...
//Name: Shell2.ma
//Last modified: Tue, Sep 27, 2016 01:22:04 PM
//Codeset: 1252
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 45.232856442313675 7.2380049576713068 0.12767395015712485 ;
	setAttr ".r" -type "double3" -5.1383527283334418 -630.59999999999559 3.7965768848223748e-014 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 46.482328613728043;
...
createNode polyTweak -n "polyTweak13";
	rename -uid "D4391D99-40D2-922B-9331-9280C84D6ADE";
	setAttr ".uopa" yes;
	setAttr -s 51 ".tk";
	setAttr ".tk[0]" -type "float3" 0 -0.067734919 0 ;
	setAttr ".tk[6]" -type "float3" 0 -0.067734919 0 ;
	setAttr ".tk[36]" -type "float3" 0 -0.067734919 0 ;
	setAttr ".tk[39]" -type "float3" 0 -0.067734919 0 ;
	setAttr ".tk[40]" -type "float3" 0 -0.29656997 0 ;
	setAttr ".tk[41]" -type "float3" 0 -0.29656997 0 ;
	setAttr ".tk[58]" -type "float3" 0 -0.29656997 0 ;
	setAttr ".tk[59]" -type "float3" 0 -0.29656997 0 ;
	setAttr ".tk[60]" -type "float3" 0 -0.53257108 0 ;
	setAttr ".tk[61]" -type "float3" 0 -0.53257108 0 ;
	setAttr ".tk[78]" -type "float3" 0 -0.53257114 0 ;
	setAttr ".tk[79]" -type "float3" 0 -0.53257114 0 ;
	setAttr ".tk[80]" -type "float3" 0 -0.9452976 0 ;
	setAttr ".tk[81]" -type "float3" 0 -0.9452976 0 ;
	setAttr ".tk[82]" -type "float3" 0 -0.094049081 0 ;
	setAttr ".tk[83]" -type "float3" 0 -0.59481037 0 ;
	setAttr ".tk[84]" -type "float3" 0 -0.094049081 0 ;
	setAttr ".tk[85]" -type "float3" 0 -0.44560504 0 ;
	setAttr ".tk[86]" -type "float3" 0 -0.094049081 0 ;
	setAttr ".tk[87]" -type "float3" 0 -0.24646783 0 ;
	setAttr ".tk[88]" -type "float3" 0 -0.094049081 0 ;
	setAttr ".tk[89]" -type "float3" 2.2351742e-008 -0.19543159 0 ;
	setAttr ".tk[90]" -type "float3" 0 -0.094049081 0 ;
	setAttr ".tk[91]" -type "float3" 2.2351742e-008 -0.19543159 0 ;
	setAttr ".tk[92]" -type "float3" 0 -0.094049081 0 ;
	setAttr ".tk[93]" -type "float3" 0 -0.24646783 0 ;
	setAttr ".tk[94]" -type "float3" 0 -0.094049081 0 ;
	setAttr ".tk[95]" -type "float3" 0 -0.41706714 0 ;
	setAttr ".tk[96]" -type "float3" 0 -0.094049081 0 ;
	setAttr ".tk[97]" -type "float3" 0 -0.56497079 0 ;
	setAttr ".tk[98]" -type "float3" 0 -0.94529766 0 ;
	setAttr ".tk[99]" -type "float3" 0 -0.94529766 0 ;
	setAttr ".tk[100]" -type "float3" 2.2351742e-008 -0.85124868 0 ;
	...
	setAttr ".tk[106]" -type "float3" 0 2.9802322e-008 0 ;
...
createNode deleteComponent -n "deleteComponent1";
	rename -uid "324157AE-4CDC-7EEE-672E-5F9B170ABFB8";
	setAttr ".dc" -type "componentList" 1 "f[49:108]";
createNode deleteComponent -n "deleteComponent2";
	rename -uid "C34464B4-4C6C-41C9-97FB-96871E9A9AE0";
	setAttr ".dc" -type "componentList" 1 "f[29:48]";
createNode polyAppend -n "polyAppend1";
	rename -uid "60DF836C-4168-40B2-3673-9C899FB8861E";
	setAttr -s 3 ".d[0:2]"  -2147483588 -2147483581 -2147483583;
	setAttr ".tx" 1;
createNode polyAppend -n "polyAppend2";
	rename -uid "5D095E32-42F1-A874-37A8-0FB92C531E68";
	setAttr -s 3 ".d[0:2]"  -2147483595 -2147483580 -2147483590;
	setAttr ".tx" 1;
createNode polyAppend -n "polyAppend3";
	rename -uid "4E3BF2A5-4FEC-DD5C-0B40-D3A2056085FC";
	setAttr -s 3 ".d[0:2]"  -2147483602 -2147483579 -2147483597;
	setAttr ".tx" 1;
createNode polyAppend -n "polyAppend4";
	rename -uid "51F968C9-449D-1C2D-AE19-999DE5D4CE10";
	setAttr -s 3 ".d[0:2]"  -2147483609 -2147483578 -2147483604;
	setAttr ".tx" 1;
createNode polyAppend -n "polyAppend5";
	rename -uid "986ACED4-4B9E-67F8-78B8-4EB2397CEAFC";
	setAttr -s 3 ".d[0:2]"  -2147483611 -2147483616 -2147483577;
	setAttr ".tx" 1;
createNode polyAppend -n "polyAppend6";
	rename -uid "BA0795E8-46F7-CF7B-626F-0C8A62742DD3";
	setAttr -s 3 ".d[0:2]"  -2147483618 -2147483623 -2147483576;
	setAttr ".tx" 1;
createNode polyAppend -n "polyAppend7";
	rename -uid "5691C7D3-4B57-9E60-3050-418163073F6F";
	setAttr -s 3 ".d[0:2]"  -2147483625 -2147483630 -2147483575;
	setAttr ".tx" 1;
createNode polyAppend -n "polyAppend8";
	rename -uid "4D1B3319-4BF7-F1E7-B7D7-CCAC6812EC08";
	setAttr -s 3 ".d[0:2]"  -2147483632 -2147483637 -2147483574;
	setAttr ".tx" 1;
createNode polyAppend -n "polyAppend9";
	rename -uid "E93A1FF7-47EB-27C4-3278-E28EF862285B";
	setAttr -s 4 ".d[0:3]"  -2147483641 -2147483639 -2147483644 -2147483573;
	setAttr ".tx" 1;
createNode polyExtrudeFace -n "polyExtrudeFace13";
	rename -uid "E41886AA-4E06-D77D-C98F-94B0D4A0F709";
	setAttr ".ics" -type "componentList" 4 "f[17]" "f[20]" "f[23]" "f[26]";
	setAttr ".ix" -type "matrix" 1.8111599152535063 0 0 0 0 1.8111599152535063 0 0 0 0 1.8111599152535063 0
		 0 0 5.7138577102894113 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0.0086194966 2.6896319 -4.5847783 ;
	setAttr ".rs" 40806;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -0.90557995762675314 -1.0197923235914137 -7.3534497656806819 ;
	setAttr ".cbx" -type "double3" 0.92281895101557987 6.3990559646562026 -1.8161066203916372 ;
createNode polyTweak -n "polyTweak14";
	rename -uid "92884AF1-49D3-98C6-9790-3A8A835A2D51";
	setAttr ".uopa" yes;
	setAttr -s 33 ".tk";
	setAttr ".tk[0]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[1]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[2]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[3]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[4]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[5]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[6]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[7]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[8]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[9]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[10]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[11]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[12]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[13]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[14]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[15]" -type "float3" 0 0 -0.58356571 ;
	setAttr ".tk[24]" -type "float3" 0 -1.1920929e-007 0 ;
	...
	setAttr ".tk[35]" -type "float3" 0 -1.1920929e-007 0 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace14";
	rename -uid "9FCCF5B3-4A63-96A8-F436-CC9AE7B54C78";
	setAttr ".ics" -type "componentList" 5 "f[29:32]" "f[40]" "f[42]" "f[44]" "f[47]";
	setAttr ".ix" -type "matrix" 1.8111599152535063 0 0 0 0 1.8111599152535063 0 0 0 0 1.8111599152535063 0
		 0 0 5.7138577102894113 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" -0.90539134 2.6896319 -6.1149192 ;
	setAttr ".rs" 35736;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -0.92281895101557987 -1.0197923235914137 -10.413731495101992 ;
	setAttr ".cbx" -type "double3" -0.88796377455735631 6.3990559646562026 -1.8161066203916372 ;
createNode polyTweak -n "polyTweak15";
	rename -uid "6FCCE0EF-4993-0E9D-FB75-B4AC2DC303F8";
	setAttr ".uopa" yes;
	setAttr -s 11 ".tk";
	setAttr ".tk[40]" -type "float3" 0 0 -1.6896805 ;
	setAttr ".tk[41]" -type "float3" 0 0 -1.6896805 ;
	setAttr ".tk[42]" -type "float3" 0 0 -1.6896805 ;
	setAttr ".tk[43]" -type "float3" 0 0 -1.6896805 ;
	setAttr ".tk[44]" -type "float3" 0 0 -1.6896805 ;
	setAttr ".tk[45]" -type "float3" 0 0 -1.6896805 ;
	setAttr ".tk[46]" -type "float3" 0 0 -1.6896805 ;
	setAttr ".tk[47]" -type "float3" 0 0 -1.6896805 ;
	setAttr ".tk[48]" -type "float3" 0 0 -1.6896805 ;
	setAttr ".tk[49]" -type "float3" 0 0 -1.6896805 ;
createNode polyExtrudeFace -n "polyExtrudeFace15";
	rename -uid "800B6BF0-4E77-F3D3-8683-86AF65DDA762";
	setAttr ".ics" -type "componentList" 1 "f[54:55]";
	setAttr ".ix" -type "matrix" 1.8111599152535063 0 0 0 0 1.8111599152535063 0 0 0 0 1.8111599152535063 0
		 0 0 5.7138577102894113 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" -2.0246954 5.9504375 -4.7676792 ;
	setAttr ".rs" 65207;
	setAttr ".lt" -type "double3" 0 -7.1163963510329594e-016 0.79506000452672065 ;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -3.1438109995187582 5.5018195204902121 -7.7192516428667117 ;
	setAttr ".cbx" -type "double3" -0.90557995762675314 6.3990559646562026 -1.8161066203916372 ;
createNode polyTweak -n "polyTweak16";
	rename -uid "D2C9F5E2-41B7-431F-8654-118CEEA94E6B";
	setAttr ".uopa" yes;
	setAttr -s 18 ".tk";
	...
	setAttr ".tk[47]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[48]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[49]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[50]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[51]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[52]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[53]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[54]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[55]" -type "float3" -1.2357998 2.9802322e-008 0 ;
	setAttr ".tk[56]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[57]" -type "float3" -1.2357998 2.9802322e-008 0 ;
	setAttr ".tk[58]" -type "float3" -1.2357998 2.9802322e-008 0 ;
	setAttr ".tk[59]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[60]" -type "float3" -1.2357998 0 0 ;
	setAttr ".tk[61]" -type "float3" -1.2357998 0 0 ;
createNode polyExtrudeFace -n "polyExtrudeFace16";
	rename -uid "6753A1E5-458C-F87E-8346-CBBB5A71822F";
	setAttr ".ics" -type "componentList" 1 "f[53]";
	setAttr ".ix" -type "matrix" 1.8111599152535063 0 0 0 0 1.8111599152535063 0 0 0 0 1.8111599152535063 0
		 0 0 5.7138577102894113 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" -1.8122844 5.5039425 -1.9533937 ;
	setAttr ".rs" 49354;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -2.7189887610959538 4.6088291050924477 -2.0906808443946963 ;
	setAttr ".cbx" -type "double3" -0.90557995762675314 6.3990559646562026 -1.8161066203916372 ;
createNode polyTweak -n "polyTweak17";
	rename -uid "1961C0C8-4B08-FDAD-3501-F5A53D22282C";
	setAttr ".uopa" yes;
	setAttr -s 22 ".tk";
	setAttr ".tk[20]" -type "float3" 0 0 1.4901161e-008 ;
	setAttr ".tk[23]" -type "float3" 0 -2.9802322e-008 1.4901161e-008 ;
	setAttr ".tk[24]" -type "float3" 0 -0.22869146 0 ;
	setAttr ".tk[27]" -type "float3" 0 0 -0.12815484 ;
	setAttr ".tk[30]" -type "float3" 0 0 -0.12815484 ;
	setAttr ".tk[39]" -type "float3" 0 -0.22869146 0 ;
	setAttr ".tk[40]" -type "float3" 0 -0.22357726 -0.21726798 ;
	setAttr ".tk[43]" -type "float3" 0 0 -0.13984422 ;
	setAttr ".tk[44]" -type "float3" 0 0 -0.13984422 ;
	setAttr ".tk[45]" -type "float3" 0 0 -0.65062237 ;
	setAttr ".tk[46]" -type "float3" 0 0 -0.65062237 ;
	setAttr ".tk[55]" -type "float3" 0.23455811 0 1.4901161e-008 ;
	setAttr ".tk[56]" -type "float3" 0.23455811 -2.9802322e-008 1.4901161e-008 ;
	setAttr ".tk[58]" -type "float3" 0 -0.22357726 -0.21726798 ;
	setAttr ".tk[60]" -type "float3" 0 0 -0.13984422 ;
	setAttr ".tk[61]" -type "float3" 0 0 -0.65062237 ;
	setAttr ".tk[62]" -type "float3" 0 -0.1115265 -0.69782287 ;
	setAttr ".tk[63]" -type "float3" 0 -0.1116787 0 ;
	setAttr ".tk[64]" -type "float3" 0 -0.1116787 0 ;
	setAttr ".tk[65]" -type "float3" 0 -0.1115265 -0.69782287 ;
	setAttr ".tk[66]" -type "float3" 0 -0.41641927 0 ;
	setAttr ".tk[67]" -type "float3" 0 -0.41641927 0 ;
createNode polyMergeVert -n "polyMergeVert22";
	rename -uid "E6C13B26-415C-1FA2-351A-12B3FBDE8570";
	setAttr ".ics" -type "componentList" 2 "vtx[16]" "vtx[69]";
	setAttr ".ix" -type "matrix" 1.8111599152535063 0 0 0 0 1.8111599152535063 0 0 0 0 1.8111599152535063 0
		 0 0 5.7138577102894113 1;
	setAttr ".am" yes;
createNode polyTweak -n "polyTweak18";
	rename -uid "DB2C6ED8-42EC-EC22-C461-738A446B57C8";
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[68]" -type "float3" -0.075034134 -0.0062141018 1.9398099 ;
	setAttr ".tk[69]" -type "float3" -0.02484056 -0.1047854 1.9049031 ;
	setAttr ".tk[70]" -type "float3" 0.45279273 -0.23083843 1.7111363 ;
	setAttr ".tk[71]" -type "float3" 0.45279273 0.23083843 1.7819443 ;
createNode polyMergeVert -n "polyMergeVert23";
	rename -uid "F7DFE8A1-407A-E0F7-896E-858919716E6D";
	setAttr ".ics" -type "componentList" 2 "vtx[19]" "vtx[68]";
	setAttr ".ix" -type "matrix" 1.8111599152535063 0 0 0 0 1.8111599152535063 0 0 0 0 1.8111599152535063 0
		 0 0 5.7138577102894113 1;
	setAttr ".am" yes;
createNode polySplitRing -n "polySplitRing1";
	rename -uid "043A4C59-4173-F8C5-DAB4-BD9D245B415A";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 17 "e[6]" "e[9:10]" "e[15]" "e[22]" "e[29]" "e[36]" "e[41]" "e[46]" "e[51]" "e[57]" "e[60:65]" "e[89]" "e[92]" "e[96]" "e[100]" "e[105]" "e[135]";
	setAttr ".ix" -type "matrix" 1.8111599152535063 0 0 0 0 1.8111599152535063 0 0 0 0 1.8111599152535063 0
		 0 0 5.7138577102894113 1;
	setAttr ".wt" 0.64481997489929199;
	setAttr ".dr" no;
	setAttr ".re" 22;
...
createNode polyTweak -n "polyTweak19";
	rename -uid "FF54C8B8-4C5F-DEA1-B89D-5E8A0F9F1659";
	setAttr ".uopa" yes;
	setAttr -s 53 ".tk";
	setAttr ".tk[0]" -type "float3" 1.4901161e-008 0 -1.4901161e-008 ;
	...
	setAttr ".tk[10]" -type "float3" 9.3132257e-010 0 -1.4901161e-008 ;
	setAttr ".tk[11]" -type "float3" -1.8626451e-009 0 -1.4901161e-008 ;
	...
	setAttr ".tk[25]" -type "float3" 0.011987503 0 0 ;
	setAttr ".tk[26]" -type "float3" -0.003181037 0 0 ;
	setAttr ".tk[27]" -type "float3" 0.11351335 0 0 ;
	setAttr ".tk[28]" -type "float3" 0.098195076 0 0 ;
	setAttr ".tk[29]" -type "float3" -0.063344046 0 0 ;
	setAttr ".tk[30]" -type "float3" 0.25077865 0 0 ;
	setAttr ".tk[31]" -type "float3" 0.16500373 0 0 ;
	setAttr ".tk[32]" -type "float3" -0.10701565 0 0 ;
	setAttr ".tk[33]" -type "float3" -0.084431469 0 0 ;
	setAttr ".tk[34]" -type "float3" 0.18798646 0 0 ;
	setAttr ".tk[35]" -type "float3" 0.11785415 0 0 ;
	setAttr ".tk[36]" -type "float3" -0.071884409 0 0 ;
	setAttr ".tk[39]" -type "float3" 0.014230016 0 0 ;
	setAttr ".tk[40]" -type "float3" 0.0017396376 0 0 ;
	setAttr ".tk[41]" -type "float3" 0.079442911 0 0 ;
	setAttr ".tk[42]" -type "float3" -0.014505997 0 0 ;
	setAttr ".tk[43]" -type "float3" 0.085729346 0 0 ;
	setAttr ".tk[44]" -type "float3" -0.0085524097 0 0 ;
	setAttr ".tk[45]" -type "float3" 0.010458966 0 0 ;
	setAttr ".tk[46]" -type "float3" 0.0011489312 0 0 ;
	setAttr ".tk[47]" -type "float3" -0.62346005 0 0 ;
	setAttr ".tk[48]" -type "float3" -0.44280276 0 0 ;
	setAttr ".tk[49]" -type "float3" -0.31108296 0 0 ;
	setAttr ".tk[50]" -type "float3" -0.45292512 0 0 ;
	setAttr ".tk[51]" -type "float3" -0.27492523 0 0 ;
	setAttr ".tk[52]" -type "float3" -0.27803296 0 0 ;
	setAttr ".tk[54]" -type "float3" -0.044947457 0 0 ;
	setAttr ".tk[58]" -type "float3" -0.027627334 0 0 ;
	setAttr ".tk[59]" -type "float3" -0.16665815 0 0 ;
	setAttr ".tk[60]" -type "float3" -0.165003 0 0 ;
	setAttr ".tk[61]" -type "float3" -0.0075792586 0 0 ;
	setAttr ".tk[67]" -type "float3" -0.0053669228 0 0 ;
	setAttr ".tk[68]" -type "float3" 0.12799196 0 -0.28902242 ;
	setAttr ".tk[69]" -type "float3" 0.22053269 0 0 ;
createNode polyMergeVert -n "polyMergeVert24";
	rename -uid "E90E29DA-4658-CD4B-27B9-46949BF33773";
	setAttr ".ics" -type "componentList" 3 "vtx[19]" "vtx[84]" "vtx[86]";
	setAttr ".ix" -type "matrix" 1.8111599152535063 0 0 0 0 1.8111599152535063 0 0 0 0 1.8111599152535063 0
		 0 0 5.7138577102894113 1;
	setAttr ".am" yes;
createNode polyTweak -n "polyTweak20";
	rename -uid "BAF33FAC-4A90-82C2-906A-038A8B50D071";
	setAttr ".uopa" yes;
	setAttr -s 43 ".tk";
	setAttr ".tk[4]" -type "float3" 7.4505806e-009 0 0 ;
	setAttr ".tk[5]" -type "float3" 0.039543226 0 0 ;
	setAttr ".tk[10]" -type "float3" 0.06298732 0 0 ;
	setAttr ".tk[11]" -type "float3" -9.3132257e-010 0 0 ;
	setAttr ".tk[14]" -type "float3" 0.07534536 0 0 ;
	setAttr ".tk[17]" -type "float3" 7.4505806e-009 0 0 ;
	setAttr ".tk[18]" -type "float3" 0.03615791 0 0 ;
	setAttr ".tk[20]" -type "float3" 4.6566129e-010 0 0 ;
	setAttr ".tk[22]" -type "float3" 0.038312584 0 0 ;
	setAttr ".tk[28]" -type "float3" 0.030704178 0 0 ;
	setAttr ".tk[42]" -type "float3" 0 0 -0.16584374 ;
	setAttr ".tk[44]" -type "float3" 0 0 -0.29677245 ;
	setAttr ".tk[51]" -type "float3" -0.30687889 0 0 ;
	setAttr ".tk[70]" -type "float3" 0.02768435 0 0 ;
	setAttr ".tk[71]" -type "float3" 0.098407127 0 0 ;
	setAttr ".tk[72]" -type "float3" 0.10427088 0 0 ;
	setAttr ".tk[74]" -type "float3" 0.10925508 0 0 ;
	setAttr ".tk[83]" -type "float3" 3.7252903e-009 0 0 ;
	setAttr ".tk[85]" -type "float3" -4.6566129e-010 0 0 ;
	setAttr ".tk[86]" -type "float3" 3.7252903e-009 0 0 ;
	setAttr ".tk[89]" -type "float3" 2.2351742e-008 0 0 ;
	setAttr ".tk[92]" -type "float3" 0.10762065 0 0 ;
	setAttr ".tk[93]" -type "float3" 0.17142524 0 0 ;
...
connectAttr "polyAppend9.out" "polyTweak14.ip";
