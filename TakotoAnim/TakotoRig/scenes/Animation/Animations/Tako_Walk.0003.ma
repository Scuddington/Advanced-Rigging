...
//Name: Tako_Walk.0003.ma
//Last modified: Tue, Dec 13, 2016 07:41:58 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -54.379747433480013 97.229994868360237 18.612325732895847 ;
	setAttr ".r" -type "double3" -13.53835272979846 -441.39999999988743 -5.3173962224847871e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "009A6750-49A3-4F9B-422C-609A5B19D580";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 98.14822003460111;
