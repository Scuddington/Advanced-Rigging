...
//Name: Tako_Walk.0001.ma
//Last modified: Tue, Dec 13, 2016 07:22:47 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -124.59970320917223 51.133849394342938 7.739150680269927 ;
	setAttr ".r" -type "double3" -2.138352729790129 -87.800000000000495 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "009A6750-49A3-4F9B-422C-609A5B19D580";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 152.20611788592919;
...
createNode reference -n "Takoto_DoneRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 21.708266572322326 3.1271151146551546 -25.962437049566574"
		...
		"translateZ" " -av"
		2 "|Takoto_Done:Takoto|Takoto_Done:Controllers|Takoto_Done:Transform_Ctrl_Grp|Takoto_Done:Transform_Ctrl|Takoto_Done:FK_Ctrl_Grp|Takoto_Done:R_Hand_FK_Ctrl_Grp|Takoto_Done:R_Hand_FK_Jnt_Ctrl_Grp|Takoto_Done:R_Hand_FK_Jnt_Ctrl" 
		"rotate" " -type \"double3\" -47.623073116911364 -55.215953370053619 52.422858758363077"
		...
		"visibility" " 1"
		2 "|Takoto_Done:Takoto|Takoto_Done:Controllers|Takoto_Done:Transform_Ctrl_Grp|Takoto_Done:Transform_Ctrl|Takoto_Done:FK_Ctrl_Grp|Takoto_Done:L_Foot_FK_Ctrl_Grp|Takoto_Done:L_Foot_01_FK_Jnt_Ctrl_Grp|Takoto_Done:L_Foot_01_FK_Jnt_Ctrl" 
		"translate" " -type \"double3\" -29.559283815998235 -2.8713166019634198 -0.056652755721085413"
		...
		"translateZ" " -av"
		2 "|Takoto_Done:Takoto|Takoto_Done:Controllers|Takoto_Done:Transform_Ctrl_Grp|Takoto_Done:Transform_Ctrl|Takoto_Done:FK_Ctrl_Grp|Takoto_Done:L_Foot_FK_Ctrl_Grp|Takoto_Done:L_Foot_01_FK_Jnt_Ctrl_Grp|Takoto_Done:L_Foot_01_FK_Jnt_Ctrl" 
		"rotate" " -type \"double3\" -0.033978590797062787 0.13982277271225296 -47.600494195003058"
...
createNode animCurveTL -n "R_Leg_IK_Ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr -s 7 ".ktv[0:6]"  1 -22.199078264471648 12 -16.475430194953127
		 24 -0.16788517265429406 36 7.7105604428494212 48 24.027326764033319 60 16.475 72 29.99;
	setAttr -s 7 ".kit[3:6]"  1 18 18 18;
	setAttr -s 7 ".kot[3:6]"  1 18 18 18;
	setAttr -s 7 ".kix[3:6]"  0.5 0.5 0.5 0.5;
	setAttr -s 7 ".kiy[3:6]"  17.383817672729492 0 0 0;
	setAttr -s 7 ".kox[3:6]"  0.5 0.5 0.5 0.5;
	setAttr -s 7 ".koy[3:6]"  17.383817672729492 0 0 0;
createNode animCurveTL -n "R_Leg_IK_Ctrl_translateY";
	rename -uid "422B3D33-4239-2AF7-B17C-22B35E28AFEA";
	setAttr ".tan" 18;
	setAttr -s 7 ".ktv[0:6]"  1 -15.670450843160955 12 -12.490642350382545
		 24 1.521866340470621 36 -0.22686117605575951 48 5.4387767680319721 60 -12.791 72 15.722;
	setAttr -s 7 ".kit[3:6]"  1 18 18 18;
	setAttr -s 7 ".kot[3:6]"  1 18 18 18;
	setAttr -s 7 ".kix[3:6]"  0.5 0.5 0.5 0.5;
	setAttr -s 7 ".kiy[3:6]"  8.7505254745483398 0 0 0;
	setAttr -s 7 ".kox[3:6]"  0.5 0.5 0.5 0.5;
	setAttr -s 7 ".koy[3:6]"  8.7505254745483398 0 0 0;
createNode animCurveTL -n "R_Leg_IK_Ctrl_translateZ";
	rename -uid "47170361-4725-DA9D-58A9-369D5A2C5364";
	setAttr ".tan" 18;
	setAttr -s 7 ".ktv[0:6]"  1 3.5527136788005009e-015 12 -0.16761185210524834
		 24 0.46297133930740031 36 -0.49590554009185067 48 1.8648998865200022 60 0.168 72 -0.378;
	setAttr -s 7 ".kit[3:6]"  1 18 18 18;
	setAttr -s 7 ".kot[3:6]"  1 18 18 18;
	setAttr -s 7 ".kix[3:6]"  0.5 0.5 0.5 0.5;
	setAttr -s 7 ".kiy[3:6]"  0.45300233364105225 0 -1.1214499473571777 
		0;
	setAttr -s 7 ".kox[3:6]"  0.5 0.5 0.5 0.5;
	setAttr -s 7 ".koy[3:6]"  0.45300233364105225 0 -1.1214499473571777 
		0;
...
createNode animCurveTU -n "R_Leg_IK_Ctrl_scaleX";
	...
	setAttr ".tan" 18;
	setAttr -s 7 ".ktv[0:6]"  1 1 12 1 24 1 36 1 48 1 60 1 72 1;
	setAttr -s 7 ".kit[3:6]"  1 18 18 18;
	setAttr -s 7 ".kot[3:6]"  1 18 18 18;
	setAttr -s 7 ".kix[3:6]"  0.5 0.5 0.5 0.5;
	setAttr -s 7 ".kiy[3:6]"  0 0 0 0;
...
createNode animCurveTL -n "Spine_01_FK_Jnt1_Ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr -s 7 ".ktv[0:6]"  1 -2.8388007844769554 12 -8.5977576464820586
		 24 -0.32369270959051732 36 2.0391071151747582 48 -2.8388007844769554 60 -8.598 71 -0.324;
	setAttr -s 7 ".kit[3:6]"  1 1 18 18;
	setAttr -s 7 ".kot[3:6]"  1 1 18 18;
	setAttr -s 7 ".kix[3:6]"  0.5 0.4583333432674408 0.5 0.45833325386047363;
	setAttr -s 7 ".kiy[3:6]"  8.5036563873291016 0 0 0;
	setAttr -s 7 ".kox[3:6]"  0.5 0.4583333432674408 0.45833325386047363 
		0.45833325386047363;
	setAttr -s 7 ".koy[3:6]"  8.5036563873291016 0 0 0;
createNode animCurveTL -n "Spine_01_FK_Jnt1_Ctrl_translateZ";
	...
	setAttr -s 7 ".ktv[0:6]"  1 -2.6645352591003682e-015 12 -2.6645352591003686e-015
		 ...
		 60 -2.6645352591003682e-015 71 -2.6645352591003682e-015;
	setAttr -s 7 ".kit[3:6]"  1 1 18 18;
	setAttr -s 7 ".kot[3:6]"  1 1 18 18;
	setAttr -s 7 ".kix[3:6]"  0.5 0.4583333432674408 0.5 0.45833325386047363;
	setAttr -s 7 ".kiy[3:6]"  0 0 0 0;
...
createNode animCurveTA -n "R_Foot_02_FK_Jnt_Ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr -s 2 ".ktv[0:1]"  1 0 48 20.648;
